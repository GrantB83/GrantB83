              ...
              <div className="pt-4 border-t space-y-3">
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <button
                    ...
                    disabled={exporting}
                    className="px-4 py-2 bg-primary text-white rounded-lg font-medium hover:bg-primary-700 transition flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    <Download className="w-4 h-4" />
                    Download .html
                  </button>
