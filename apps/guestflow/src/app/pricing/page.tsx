    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="bg-red-50 border-4 border-red-600 rounded-xl p-8 text-center mb-8">
        ...
        <p className="text-lg text-red-800 mb-4">
          This page has been removed. GuestFlow is now an <strong>internal Browns operations console</strong>, not a SaaS product for sale.
        </p>
        <p className="text-base text-red-700 mb-6">
          There is no pricing, no waitlist, and no public signup. This is internal ops automation for The Browns Luxury Guest Suites (Dullstroom) only.
        </p>
        <Link
          href="/"
