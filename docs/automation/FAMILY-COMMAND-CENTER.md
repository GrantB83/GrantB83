...
- **Family locked the 7th close** (2026-08-23): reminder-only is out. Test phrase `TEST CLOSE: now` — use the existing Monarch dry-run, write a test Budget vs Actual tab, do not freeze the official close.
