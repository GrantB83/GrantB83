...
| --- | --- | --- | --- | --- | --- | --- | --- |
| GuestFlow Sprint 6 inbox / WA Web bodies / composer | Wait ~30s for 83 threads; open WA Web to read `[body unavailable]` stay text; cramped mystery-icon composer | 0.8–1.5 (stay morning) | 0.2 first-page triage + one-shot Refresh bodies | | | 2026-09-26 coded | `specs/verify/sprint-6/VERIFY-PACK.md` + Preview #251 READY |
| GuestFlow Sprint 5 inbox / journey / portal | Chip-rainbow triage; Template&Care split composer hiding Approve&Send; Staff-mislabelled guest contacts; guests on thebrowns.co.za/checkin + /info | 1–2 (stay morning + arrival codes) | 0.3 review drafts + Approve&Send | | | 2026-09-26 coded | `apps/guestflow/docs/SPRINT5-INBOX-PORTAL.md` + `/?fixture=1` |
