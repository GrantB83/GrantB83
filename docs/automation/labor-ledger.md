...
| --- | --- | --- | --- | --- | --- | --- | --- |
<<<<<<< HEAD
| GuestFlow Sprint 2 data-fixes | Eyeball cancelled/BLOCK rows, guess Cottage vs Main House from suite names, and triage empty Inbox threads | 1–2 (stay morning) | 0.2 scan brief + exceptions | | | 2026-09-25 coded | Preview `/ops/daily-brief` + `/api/exceptions` |
=======
| GuestFlow staff users | Share one staff password; ask Grant to rotate it when someone should lose access | 0.3–0.5 + lockout risk | 0 (add/remove on `/ops/users`) | | | 2026-09-24 coded | `apps/guestflow/docs/STAFF-USERS.md` |
