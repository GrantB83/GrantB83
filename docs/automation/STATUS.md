...
Last orchestrator review: 2026-08-29 (six-role Grok Bot team retired; live Bot is Grant’s desktop Grok Bot).
...
- **Live Grok Bot** (2026-08-29): Grant’s **desktop** Bot, already set up (SuperGrok mail 2026-08-27 + Grant confirmed). Product link: [https://x.ai/bot](https://x.ai/bot). Docs: [https://docs.x.ai/grok-bot/bots](https://docs.x.ai/grok-bot/bots). Record: `bot-roster.yaml`. The 2026-08-22 six-role team (Ops Chief / Family / Stay / Aqua / Yard / Vault and Old - * names) is **retired**. Do **not** recreate it. Do **not** invent a sidebar name. Optional: paste `LIVE BOT: name=…` or `LIVE BOT: share=https://…`. Do **not** reopen merged [PR #4](https://github.com/GrantB83/GrantB83/pull/4).
...
| --- | --- | --- | --- | --- | --- |
| 0 | Control plane & safety | **in progress** | desktop Grok Bot is live; Cloud Agents stay on-demand | stop re-briefing agents | `G2` private repos |
...
| 10b | Family digest | **owned by desktop Grok Bot** | first labelled-queue fire on that Bot | 10 min/day | S10/S11 off |
...
| Date | Decision |
| --- | --- |
| 2026-08-29 | Retire the 2026-08-22 six-role Grok Bot team. Live orchestrator is Grant’s already-set-up desktop Bot. Link: https://x.ai/bot. Do not invent a sidebar name. Do not recreate Ops Chief / Family / Stay / Aqua / Yard / Vault. |
